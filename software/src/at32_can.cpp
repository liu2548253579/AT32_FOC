...
CAN_msg_t CANmsg2PC_rotary1_2 = { .id = 0xA9EC417, .data = { 0x5b }, .len = 8, .format = 1, .type = 0 };  //merge into one message

void CAN_MSG_Center(void)
{
    CAN_msg_t CAN_TX_msg;
    CAN_msg_t CAN_RX_msg;
    static unsigned short pos_left = 0;
    static unsigned short pos_right = 0;
    unsigned long time_line = 0;
    CANmsg2PC_rotary1_2.data[0] = pos_left % 256;
    CANmsg2PC_rotary1_2.data[1] = (pos_left >> 8) % 256;
    CANmsg2PC_rotary1_2.data[2] = pos_right % 256;
    CANmsg2PC_rotary1_2.data[3] = (pos_right >> 8) % 256;
    CANmsg2PC_rotary1_2.data[4] = time_line % 256;
    CANmsg2PC_rotary1_2.data[5] = (time_line >> 8) % 256;
    CANmsg2PC_rotary1_2.data[6] = (time_line >> 16) % 256;
    CANmsg2PC_rotary1_2.data[7] = (time_line >> 24) % 256;
    CAN_TX_msg=CANmsg2PC_rotary1_2;
    CANSend(&CAN_TX_msg);
